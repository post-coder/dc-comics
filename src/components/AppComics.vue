...
<template>
  <div class="container">
    ...
    <div id="comics-container">
      ...
      <ComicItem v-for="comic in comics" :thumb="comic.thumb" :title="comic.series"></ComicItem>
...
<style lang="scss" scoped>
  ...
  // così importiamo le variabili globali della nostra app
  ...
  h2 {
    ...
    // qui usiamo una variabile del file importato precedentemente
